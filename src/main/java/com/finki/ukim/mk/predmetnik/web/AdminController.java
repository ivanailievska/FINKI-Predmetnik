...
import com.finki.ukim.mk.predmetnik.exceptions.ProfessorAlreadyExistsException;
...
public class AdminController {
    ...
    public String addPreference(@RequestParam String preferenceName,
        ...
        List<Course> suggestedCourses = courses.stream()
                .map(course -> this.courseService.findById(course).orElse(null))
                .collect(Collectors.toList());
        this.preferenceService.save(new Preference(preferenceName, suggestedCourses));
        return "redirect:/admin";
    }
